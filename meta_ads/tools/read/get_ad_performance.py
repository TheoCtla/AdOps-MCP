"""Tool: meta_ads_get_ad_performance.

Performances des ads Meta Ads. Un seul appel insights avec level=ad
pour éviter les timeouts et rate limits.
"""
...
TOOL_NAME = "meta_ads_get_ad_performance"
...
TOOL_DEFINITION = Tool(
    name=TOOL_NAME,
    description=(
        "Fetch per-ad performance metrics for a Meta Ads account.\n"
        "\n"
        "Returns a JSON object with `ad_account_id`, `date_range`, `total_ads`, `totals`, "
        "and `ads` (array). Each entry contains: ad_id, ad_name, campaign_id, campaign_name, "
        "adset_id, adset_name, impressions, clicks, spend, cpm, cpc, ctr, reach, frequency, "
        "leads, purchases, cpa_lead, cpa_purchase, roas.\n"
        "\n"
        "Use this tool to compare ad-level performance, find underperformers, or analyze "
        "which ads drive conversions. Filter by campaign_id or adset_id to scope the query. "
    ...
    inputSchema={
        ...
        "properties": {
            ...
            "adset_id": {
                "type": "string",
                "description": "Optional ad set ID to scope the query.",
            },
            "date_from": {
                "type": "string",
            ...
            "status": {
                ...
                "description": "Filter by ad status. Default: ALL.",
                "default": "ALL",
            },
            "limit": {
                "type": "integer",
                "minimum": 1,
                "maximum": 200,
                "description": "Max ads returned. Default: 25.",
                "default": 25,
            },
        },
...
async def handler(arguments: dict[str, Any]) -> list[TextContent]:
    """Handler for meta_ads_get_ad_performance."""
    args = arguments or {}
    ...
    try:
        ...
        log.exception("Erreur dans meta_ads_get_ad_performance")
