"""Tool: meta_ads_enable_campaign.

Réactive une campagne Meta Ads en pause.
"""
...
TOOL_NAME = "meta_ads_enable_campaign"


TOOL_DEFINITION = Tool(
    name=TOOL_NAME,
    description=(
        "Enable (reactivate) a paused Meta Ads campaign, immediately resuming ad delivery.\n"
        "\n"
        "Returns a JSON confirmation with success status and the campaign_id.\n"
        "\n"
        "Use this tool when the user wants to reactivate a previously paused campaign.\n"
        "\n"
...
async def handler(arguments: dict[str, Any]) -> list[TextContent]:
    """Handler for meta_ads_enable_campaign."""
    args = arguments or {}
    ...
    try:
        ...
        log.exception("Erreur dans meta_ads_enable_campaign")
