"""Tool: google_ads_enable_keyword.

Réactive un keyword en pause au sein d'un ad group.
"""
...
TOOL_NAME = "google_ads_enable_keyword"


TOOL_DEFINITION = Tool(
    name=TOOL_NAME,
    description=(
        "Enable (reactivate) a paused keyword (ad group criterion) in a Google Ads ad group, "
        "immediately allowing it to trigger ads again.\n"
        "\n"
        "Returns a JSON confirmation with success status, action taken, and the resource name.\n"
        "\n"
        "Use this tool when the user wants to reactivate a previously paused keyword.\n"
        "\n"
        "⚠️ This tool MODIFIES data. Enabling a keyword allows it to trigger ads immediately "
    ...
    inputSchema={
        ...
        "properties": {
            ...
            "criterion_id": {
                "type": "string",
                "description": (
                    "Numeric criterion ID of the keyword to enable. Use "
                    "google_ads_get_keywords to find it."
                ),
            },
        },
...
async def handler(arguments: dict[str, Any]) -> list[TextContent]:
    """Handler for google_ads_enable_keyword."""
    args = arguments or {}
    ...
    try:
        ...
        log.exception("Erreur inattendue dans google_ads_enable_keyword")
