"""Tool: google_ads_enable_ad.

Réactive une annonce en pause au sein d'un ad group.
"""
...
TOOL_NAME = "google_ads_enable_ad"


TOOL_DEFINITION = Tool(
    name=TOOL_NAME,
    description=(
        "Enable (reactivate) a paused ad within an ad group, immediately resuming its "
        "delivery.\n"
        "\n"
    ...
    inputSchema={
        ...
        "properties": {
            ...
            "ad_id": {
                "type": "string",
                "description": (
                    "Numeric ad ID to enable. Use google_ads_get_ads to find it."
                ),
            },
        },
...
async def handler(arguments: dict[str, Any]) -> list[TextContent]:
    """Handler for google_ads_enable_ad."""
    args = arguments or {}
    ...
    try:
        ...
        log.exception("Erreur inattendue dans google_ads_enable_ad")
